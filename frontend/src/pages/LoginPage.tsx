...
const LoginPage = (): React.JSX.Element => {
  ...
  // 3. Type the event parameter for handleLogin and onChange
    ...
    >
      <div className="border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-8 flex flex-col">
          ...
          {/* Ensure error is treated as AxiosError to access .response.data.message */}
          {error && (
                ...
                <div className="flex flex-col gap-3">
                  <div className="form-control w-full space-y-2">
                    ...
                    <input
                      ...
                      name="email" // Add name attribute for simpler handleInputChange
                  ...
                  <div className="form-control w-full space-y-2">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="input input-bordered w-full"
                      name="password" // Add name attribute for simpler handleInputChange
