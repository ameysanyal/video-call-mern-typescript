  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <div className="relative w-full h-full">
        {' '}
        {/* Use full width/height for video content */}
        {client && call ? (
...
const CallContent = (): React.JSX.Element | null => {
  // Can return null if navigate happens
  const { useCallCallingState } = useCallStateHooks();
  const callingState = useCallCallingState(); // This will be typed by Stream SDK

  const navigate = useNavigate(); // This will be typed by react-router
